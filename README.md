...
* Вписать в качестве ConnectionString, например, postgreConnectionString = "Server=localhost;Port=21349;Database=AvanpostDB;User Id=postgres;Password=Q!2werty;"
