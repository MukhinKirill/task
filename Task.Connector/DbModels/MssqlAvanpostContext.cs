...
{
    public partial class MssqlAvanpostContext : DbContext
    {
        public MssqlAvanpostContext()
        {
        }

        public MssqlAvanpostContext(DbContextOptions<MssqlAvanpostContext> options)
            : base(options)
        {
        }
