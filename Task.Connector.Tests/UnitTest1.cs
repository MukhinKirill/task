...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Server=127.0.0.1;Port=5432;Database=AvanpostTestDB;Username=admin;Password=3562;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"{DateTime.Now.ToString("yyyy-dd-M--HH-mm-ss")}connector{provider}.Log", $"{DateTime.Now}connector{provider}");
            return connector;
        }
