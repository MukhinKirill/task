...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Server=127.0.0.1;Port=5432;Database=testDb;Username=admin;Password=root;";
        static Dictionary<string, string> connectorsCS = new Dictionary<string, string>
        {
            ...
            { "POSTGRE", $"ConnectionString='{postgreConnectionString}';Provider='PostgreSQL.15.9';SchemaName='AvanpostIntegrationTestTaskSchema';"}
        };
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"{DateTime.Now:yyyy-MM-dd}connector{provider}.Log", $"connector{provider}");
