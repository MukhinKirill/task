...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Host=localhost;Port=19111;Database=avanpostDb;User Id=postgres;Password=PostgresPassword;Include Error Detail=true;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"connector{provider}.Log", $"{DateTime.Now}connector{provider}");//не работает с датой
            return connector;
        }
