...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Server=127.0.0.1;Port=5432;Database=avanpostDb;Username=postgres;Password=123;";
        ...
        [Theory]
        [InlineData("MSSQL", Skip = "Не используется")]
        [InlineData("POSTGRE")]
