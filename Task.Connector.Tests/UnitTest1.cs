...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string mssqlConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;Initial Catalog=AvanpostTest";
        static string postgreConnectionString = "Server=127.0.0.1;Port=8080;Database=AvanpostTest;Username=postgres;Password=postgres;";
