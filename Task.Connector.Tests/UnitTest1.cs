...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Server=127.0.0.1;Port=5432;Database=testDb;Username=postgres;Password=postgres;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"connector{provider}.Log", $"{DateTime.Now}connector{provider}");
            return connector;
        }
