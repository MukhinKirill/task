...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Server=localhost;Port=5432;Database=my_db;Username=Kolleper;Password=123456;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            //была ошибка, исправил убрав вывод часов
            connector.Logger = new FileLogger($"{DateTime.Now.ToShortDateString()}connector{provider}.Log", $"{DateTime.Now}connector{provider}");
            return connector;
        }
