...
namespace Task.Connector.Tests
{
	...
	{
		static readonly string requestRightGroupName = "Request";
		static readonly string itRoleRightGroupName = "Role";
		static readonly string delimeter = ":";
		static readonly string mssqlConnectionString = "";
		static readonly string postgreConnectionString = ConnectorDb.PostgreSqlConnectionString;
		static readonly Dictionary<string, string> connectorsCS = new Dictionary<string, string>
		{
		...
		static readonly Dictionary<string, string> dataBasesCS = new Dictionary<string, string>
		{
		...
		public IConnector GetConnector(string provider)
		{
			...
			connector.Logger = new FileLogger($"{DateTime.Now.ToString(CultureInfo.CurrentCulture).Replace(':', '-')}connector{provider}.Log", $"{DateTime.Now}connector{provider}");
			return connector;
		}
