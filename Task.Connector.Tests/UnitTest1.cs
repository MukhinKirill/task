...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString =
            "Server=database;port=5432;Database=1;User ID=1;Password=1;Pooling=true;Connection Lifetime=0;SslMode=Disable;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"{DateTime.Now.ToString("yyyy.MM.dd-HH_mm_ss")}connector{provider}.Log",
                $"{DateTime.Now} connector {provider}");
