...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
       ...
       // static string mssqlConnectionString = "";
        static string postgreConnectionString = "host=127.0.0.1;Port=5432;Database=testDb;Username=postgres;Password=1234;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"{DateTime.Now.Ticks}connector{provider}.Log", $"{DateTime.Now}connector{provider}");
            return connector;
        }
