...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string postgreConnectionString = "Server=localhost;Port=21349;Database=AvanpostDB;User Id=postgres;Password=Q!2werty;";
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"{DateTime.Now.ToString("dd_MM_yyyy HH_mm_ss")}connector{provider}.Log", $"{DateTime.Now.ToString("dd_MM_yyyy HH_mm_ss")}connector{provider}");
